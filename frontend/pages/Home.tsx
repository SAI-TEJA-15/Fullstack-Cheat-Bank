    ...
    return (
        <div className="space-y-12">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard icon="fa-eye" value={cheatSheets.reduce((sum, sheet) => sum + sheet.stats.views, 0).toLocaleString()} label="Total Views" />
                <StatCard icon="fa-download" value={cheatSheets.reduce((sum, sheet) => sum + sheet.stats.downloads, 0).toLocaleString()} label="Downloads" />
                <StatCard icon="fa-users" value={currentUser?.role === 'admin' ? 'Admin' : 'User'} label="Signed In As" />
            </section>
